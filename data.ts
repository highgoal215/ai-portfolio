...
export const experience1 = [
  {
      ...
      company: "Self-employed, City, Country",
      time: "Start Date - Present",
      description: [
          "Led the development of XXXX website, ensuring client satisfaction and timely delivery.",
          "Ensured the website's design and functionality aligned with modern web standards, providing an engaging and user-friendly experience."
      ]
  },
  {
