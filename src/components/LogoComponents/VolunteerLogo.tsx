export default function VolunteerLogo() {
    return (
        <svg
        ...
        >
            ...
            />
            <path
            d="M46.014 33.559l6.844 6.841a4 4 0 0 1-5.658 5.66l-6.239-6.242"
            data-name="layer2"
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
            ...
            />
            <path
            d="M40.962 39.818l4.825 4.827a4 4 0 0 1-5.652 5.655l-2.827-2.828"
            data-name="layer2"
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
            ...
            />
            <path
            d="M15.6 36.163a4 4 0 1 0-5.653-5.655l-2.825 2.827a4 4 0 0 0 5.655 5.656z"
            data-name="layer1"
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
            ...
            />
            <path
            d="M32.258 53.436A4 4 0 1 0 26.6 47.78l-1.392 1.393a4 4 0 0 0 5.655 5.657z"
            data-name="layer1"
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
